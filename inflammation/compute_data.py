...
class CSVDataSource:
    ...
    def load_inflammation_data(self):
        """ Loads all inflammation data csv files within a
        directory by applying models.load_csv

        :data_dir: directory containing inflammation files; assumes
        files have filename beginning with "inflammation"
        - output: list of 2D Numpy arrays with inflammation data.
        """
